-- Eligible instances: match batch students + date window + form linked to p_course_id in
-- skyline_course_forms (same semantics as joining a course_units CTE). Units list remains
-- the union of course-linked forms and forms appearing in eligible rows.
