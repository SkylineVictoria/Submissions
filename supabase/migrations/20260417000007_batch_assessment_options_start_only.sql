-- Extend skyline_batch_assessment_options: optional mode where only "From" is set filters
-- instances with start_date = p_from_date and end_date IS NULL (no end date yet).
